...
import { ReportAccountDetailTableWrapper } from './PersonalReportAccountDetailTableStyled'
...
const PersonalReportAccountDetailTable = props => {
    ...
    reportStore.getAccountDetailsExcel(payloadAcc)
      .then(res => {
        if (res?.responseCode === RESPONSE_CODE.SUCCESS) {
          ...
          fileUtils.saveAsFile('TTTK Vi CN', res?.report)
          Modal.destroyAll()
        }
      })
  }
  ...
  return (
    <ReportAccountDetailTableWrapper>
      <Divider
        ...
        BÁO CÁO THÔNG TIN TÀI KHOẢN VÍ ĐIỆN TỬ CÁ NHÂN
      </Divider>
...
PersonalReportAccountDetailTable.propTypes = {
...
export default inject('reportStore')(observer(PersonalReportAccountDetailTable))