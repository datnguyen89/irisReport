...
import { ReportPaymentTableWrapper } from './PersonalReportPaymentTableStyled'
...
const PersonalReportPaymentTable = props => {
    ...
    reportStore.getPaymentReportExcel(payloadPayment)
      .then(res => {
        if (res?.responseCode === RESPONSE_CODE.SUCCESS) {
          ...
          fileUtils.saveAsFile('TTMS Vi CN', res?.report)
          Modal.destroyAll()
        }
      })
  }
  ...
  return (
    <ReportPaymentTableWrapper>
      <Divider
        ...
        BÁO CÁO THANH TOÁN MUA SẮM TÀI KHOẢN VÍ ĐIỆN TỬ CÁ NHÂN
      </Divider>
...
PersonalReportPaymentTable.propTypes = {
...
export default inject('reportStore')(observer(PersonalReportPaymentTable))