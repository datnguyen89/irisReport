...
import { UploadCSVModuleWrapper } from './UploadCSVModuleStyled'
import { ERROR_COLOR } from '../../utils/constant'


const UploadCSVModule = props => {
    ...
    if (file) {
      ...
      if (!isAcceptType) {
        notification.error({
          ...
          description: 'Vui lòng chọn file định dạng csv',
        })
        return
      }
