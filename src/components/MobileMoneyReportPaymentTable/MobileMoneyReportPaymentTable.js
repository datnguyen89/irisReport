...
import { ReportPaymentTableWrapper } from './MobileMoneyReportPaymentTableStyled'
...
const MobileMoneyReportPaymentTable = props => {
    ...
    reportStore.getPaymentReportExcel(payloadPayment)
      .then(res => {
        if (res?.responseCode === RESPONSE_CODE.SUCCESS) {
          ...
          fileUtils.saveAsFile('TTMS Tien di dong', res?.report)
          Modal.destroyAll()
        }
      })
  }
  ...
  return (
    <ReportPaymentTableWrapper>
      <Divider
        ...
        BÁO CÁO THANH TOÁN MUA SẮM TÀI KHOẢN TIỀN DI ĐỘNG
      </Divider>
...
MobileMoneyReportPaymentTable.propTypes = {
...
export default inject('reportStore')(observer(MobileMoneyReportPaymentTable))